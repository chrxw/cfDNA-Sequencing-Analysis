...
train_svm_model <- function(training_set, validation_set, testing_set) {
  ...
  y_pred_train_class <- predict(svm_model, training_set, type = "raw")          # Class predictions
  ...
  plot_combined_roc("D:/CPE407/THESIS/Result Normal/svm_roc_normal.png")
