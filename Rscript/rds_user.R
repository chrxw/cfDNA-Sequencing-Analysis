...
all_feature <- c(sample_names, isize_len, isize_label, most_frequent_motif_fwd_1, 
                 ...
                 CES_score, sl_ratio, tumor_fraction[[sample_counter]])
...
column_names <- c("sample_id", "isize_peak", "isize_label", "motif_peak_fwd_1", "motif_peak_fwd_2", 
                  ...
                  "pattern_prop_2", "ces", "sl_ratio", "tumor_fraction")
...
saveRDS(cfdna_df, file = paste0("gs://home/chrwan_ja/", user_filenames, "/output/", 
                                user_filenames, ".rds"))